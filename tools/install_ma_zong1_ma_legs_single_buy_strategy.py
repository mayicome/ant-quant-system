...
参照「买：马总逻辑1-涨停后跌破MA5/10/20各1/3」（弹性 best_buy），
...
STRATEGY_NAME = "买：马总逻辑1-涨停后跌破MA10/20各1/2-单点"
LEGACY_NAMES = (
    STRATEGY_NAME,
    "买：马总逻辑1-涨停后跌破MA5/10/20各1/3-单点",
)
PREFERRED_ID = "strategy_dacdcef1"

STRATEGY_CODE = r'''# 买：马总选股逻辑1 — 涨停后第一次跌至 MA10/MA20 各买 1/2（单点买入；不买 MA5）
# - 触发价 = 均线重合点（行情字段「10日」「20日」）
...
LEG_SPECS = (
    ("MA10", "10日", "马总1单点-跌破MA10"),
    ("MA20", "20日", "马总1单点-跌破MA20"),
)
