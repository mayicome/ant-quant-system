# -*- coding: utf-8 -*-
"""安装策略：买：马总逻辑1-涨停后跌破MA5/10/20各1/3-单点

参照「买：马总逻辑1-涨停后跌破MA10/20各1/2」（弹性）与其单点版：
- 增加跌破 MA5 买点；三腿各买单股拟买入金额的 1/3
- 弹性 best_buy 改为单点 single_buy：现价 <= 均线触发价即买

- 触发：均线重合点（行情「5日」「10日」「20日」）
- 仓位：单股拟买入金额 / 3
...
STRATEGY_NAME = "买：马总逻辑1-涨停后跌破MA5/10/20各1/3-单点"
LEGACY_NAMES = (STRATEGY_NAME,)
PREFERRED_ID = "strategy_mz1_ma51020_third_single"

STRATEGY_CODE = r'''# 买：马总选股逻辑1 — 涨停后第一次跌破 MA5/MA10/MA20 各买 1/3（单点买入）
...
# - 腿名固定：马总1单点-跌破MA5 / MA10 / MA20（实盘重启靠同名合并 executed）
...
LEG_SPECS = (
    ("MA5", "5日", "马总1单点-跌破MA5", 5),
    ("MA10", "10日", "马总1单点-跌破MA10", 10),
    ("MA20", "20日", "马总1单点-跌破MA20", 20),
)
